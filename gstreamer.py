...
def run_pipeline(user_function,
    ...
    if videosrc.endswith('.rgb'):
        _run_opencv_rgb(videosrc, user_function, src_size, appsink_size)
        return
...
def _run_opencv_rgb(path, user_function, src_size, inf_size):
    w, h = src_size
    ...
    with open(path, "rb") as f:
        while True:
            ...
            # INPUT doğrudan numpy array olarak geçilecek
            svg = user_function(frame_resized, (w, h), box, None)
